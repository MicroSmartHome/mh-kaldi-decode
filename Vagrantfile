...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_version = "20180112.0.0"
  config.vm.provision :shell, path: "vagrant-sync-folder/bootstrap-00.sh"
  ...
  config.vm.synced_folder "vagrant-sync-folder", "/vagrant"
  config.vm.synced_folder "vagrant-sync-python-src", "/vagrant-python-src"
